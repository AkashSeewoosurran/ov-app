...
@Component({
  selector: 'app-obs1-overlay',
  templateUrl: './obs1-overlay.component.html',
  styleUrls: ['./obs1-overlay.component.scss'],
  animations: [
    trigger('slideUpDown', [
      state(
        'up',
...
export class Obs1OverlayComponent implements OnInit {
